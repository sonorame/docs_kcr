...
| Название                                            | UC-1: Аутентификация пользователя                                                                                                                  					           		                            |
|-----------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Краткое описание                                    | Вход в систему                                                                                                                                                                 			                        |
| Субъекты                                            | 1. Пользователь<br/>2. Система                                                                                                                                                            						|
| Предусловие                                         | Создана учетная запись пользователя                                                                                                                                                                        		|
| Основной сценарий                                   | 1. Пользователь вводить учетные данные и нажимает кнопку N1. <br/>1. Если логин или пароль введены некорректно - AF-1 <br/>2. Аутентификация пройдена. Система открывает главную страницу. Конец сценария. 		|
| Альтернативный сценарий                             | AF1: Информация заполнена некорректно. <br/>1. Система выводит пользователю информационное сообщение о том, что введены некорректные данные и кнопку N2.<br/>    2. Пользователь нажимает N2. Конец сценария. 	|
| Наименования элементов пользовательского интерфейса | N1: "Войти" <br/>N2: "Ок"                                                                                            																                    		|	
| Диаграмма                                           | ![](diagrams/out/auth.svg){ width="100" }                                                                                                                                                                       |

#### Загрузка ЦАР через СМЭВ

| Название                                            | UC-2: Загрузка ЦАР через СМЭВ                                                                                                                                                                                                                                               |
|-----------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
| Название                                            | UC-3: Загрузка ЦАР вручную                                                                                                                                                                                                                                                                                                                              |
|-----------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Краткое описание                                    | Создать новую карточу ЦАР в системе для получения возможности выполнять обращения                                                                                                                                                                                                                                                                       |
| Субъекты                                            | 1. Пользователь<br/>2. Система                                                                                                                                                                                                                                                                                                                          |
| Предусловие                                         | Пользователь зашел в реестр услуг                                                                                                                                                                                                                                                                                                                       |
...
| Название                                            | UC-4: Просмотр информации о ЦАР                                                                                  |
| --------------------------------------------------- | -----------------------------------------------------------------------------------------------------------------|
...
| Название                                            | UC-5: Просмотр информации о подуслугах                                                                                      |
| --------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------- |
...
#### Просмотр истории изменений ЦАР

| Название                                            | UC-6: Просмотр истории изменений ЦАР                                                                                                                     |
| --------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------|
| Краткое описание                                    | Просмотр информации о версиях изменений ЦАР                                                                                                              |
| Субъекты                                            | 1\. Пользователь<br>2\. Система                                                                                                                          |
| Предусловие                                         | Пользователь зашел в реестр услуг                                                                                                                        |
| Основной сценарий                                   | 1\. Пользователь нажимает на кнопку N1.<br>2\. Система открывает окно с информацией о версиях изменения ЦАР (версия, дата изменения). Конец сценария.    |
| Наименования элементов пользовательского интерфейса | N1: "История изменений"                                                                                                                                  |

#### Создание обращение

| Название                                            | UC-7: Создание обращений                                                                                                                                                                                                                                                                                                                                                                                                          |
| --------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Краткое описание                                    | Создание обращений для оказания услуги                                                                                                                                                                                                                                                                                                                                                                                            |
| Субъекты                                            | 1\. Пользователь<br>2\. Система                                                                                                                                                                                                                                                                                                                                                                                                   |
| Предусловие                                         | Пользователь зашел в реестр обращений                                                                                                                                                                                                                                                                                                                                                                                             |
| Основной сценарий                                   | 1\. Пользователь нажимает кнопку N1.<br>2\. Система открывает окно создания обращений.<br>3\. Пользователь выбирает услугу, подуслугу.<br>4\. На основании выбранной информации, система выводит поля для заполнения.<br>5\. Пользователь заполняет необходимые поля<br>6\. Пользователь нажимает кнопку N2.<br>1. Если заявитель подал заявление через ЕПГУ - AF-1.<br>7\. Система сохраняет введеную информацию. Конец сценария.|
| Альтарнативный сценарий                             | AF-1: US-8, US-9 Автоматическое создание обращений из ЕПГУ<br>1\. Система получает информацию о заявлении из ЕПГУ через СМЭВ.<br>2\. Система создает карточку обращения на основании полученной информации из ЕПГУ. Конец сценария.                                                                                                                                                                                               |
| Наименования элементов пользовательского интерфейса | N1: "+"<br>N2: "Сохранить"                                                                                                                                                                                                                                                                                                                                                                                                        |
| Диаграмма                                           | ![](diagrams/out/create_task.svg){ width="100" }             																																																																																									  |

#### Обработка обращений

| Название                                            | UC-10: Обработка обращений                                                                                                                                                                                                                                                                                                                         |
|-----------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Краткое описание                                    | Обработка обращений с целью оказания услуги заявителю                                                                                                                                                                                                                                                                                              |
| Субъекты                                            | 1. Пользователь<br/>2. Система                                                                                                                                                                                                                                                                                                                     |
| Предусловие                                         | Пользователь зашел в реестр обращений                                                                                                                                                                                                                                                                                                              |
| Основной сценарий                                   | 1. Пользователь нажимает кнопку N1. <br/>2. Система меняет статус - US-11 и добавляет новую вкладку N2.<br/>3. Пользователь нажимает кнопку N3.<br/>1. Если пользователь нажимает кнопку N4 - AF-1<br/>4. Система меняет статус - US-11 и открывает окно для создания резолюции.<br/>5. Пользователь заполняет поля и нажимает N5. Конец сценария. |
| Альтернативный сценарий                             | AF1: Отказ в предоставлении услуги.<br/>1. Система меняет статус - US-11 и открывает окно для создания резолюции.<br/>2. Пользователь заполняет поля и нажимает N5. Конец сценария.                                                                                                                                                                |
| Наименования элементов пользовательского интерфейса | N1: "Зарегистрировать" <br/>N2: "Межведомственное взаимодействие" <br/>N3: "Принять решение" <br/>N4: "Отказ" <br/>N5: "Сохранить"                                                                                                                                                                                                                 |
| Диаграмма                                           | ![](diagrams/out/do_task.svg){ width="100" }                                                                                                                                                                                                                                                                                                       |

#### Создание межведомственных запросов  

| Название                                            | UC-12: Создание межведомственных запросов                                                                                                                                                                                                                                                                                                                                                   |
|-----------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
