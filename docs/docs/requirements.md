...
| Основной сценарий                                   | 1\. Пользователь нажимает кнопку N1.<br>2\. Система открывает окно создания обращений.<br>3\. Пользователь выбирает услугу, подуслугу.<br>4\. На основании выбранной информации, система выводит поля для заполнения.<br>5\. Пользователь заполняет необходимые поля<br>6\. Пользователь нажимает кнопку N2.<br>7\. Система сохраняет введеную информацию. Конец сценария.|
...
| Субъекты                                            | 1. Пользователь<br/>2. Система                                                                                                                                                                                                                                                                                                                     |
| Предусловие                                         | Пользователь зашел в реестр обращений                                                                                                                                                                                                                                                                                                              |
| Основной сценарий                                   | 1. Пользователь нажимает кнопку N1. <br/>2. Система меняет статус - UC-11 и добавляет новую вкладку N2.<br/>3. Пользователь нажимает кнопку N3.<br/>1. Если пользователь нажимает кнопку N4 - AF-1<br/>4. Система меняет статус - UC-11 и открывает окно для создания резолюции.<br/>5. Пользователь заполняет поля и нажимает N5. Конец сценария. |
| Альтернативный сценарий                             | AF1: Отказ в предоставлении услуги.<br/>1. Система меняет статус - UC-11 и открывает окно для создания резолюции.<br/>2. Пользователь заполняет поля и нажимает N5. Конец сценария.                                                                                                                                                                |
